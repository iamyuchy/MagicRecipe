        ...
        for gens in range(args.numgens):
            with torch.no_grad():
                ...
                if args.get_perplexity:
                    ...
                    print("Check 9: {0} ".format(outputs))
